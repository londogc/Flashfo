...
const MODES = [
  ...
  { label:'Nova Study Session', desc:'Ask questions and get personalized explanations.', href:'/ai-tutor', bg:'bg-violet-500/10', ic:'text-violet-500', icon:'M8 1a7 7 0 100 14A7 7 0 008 1zm0 10a3 3 0 100-6 3 3 0 000 6z' },
