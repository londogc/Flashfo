  ...
  return (
    <>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div style={{position:'absolute',top:0,left:20,right:-22,bottom:-16,borderRadius:16,border:'1.5px solid rgba(255,255,255,0.25)',background:'rgba(255,255,255,0.12)',pointerEvents:'none'}}/>
        <div style={{position:'absolute',top:0,left:10,right:-11,bottom:-8,borderRadius:16,border:'1.5px solid rgba(255,255,255,0.2)',background:'rgba(255,255,255,0.09)',pointerEvents:'none'}}/>
