  ...
  return (
    <>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div ref={cardDragRef} style={{position:'absolute',inset:0,cursor:flipped?'grab':'pointer',willChange:'transform',borderRadius:16,boxShadow:'11px 0 0 0 rgba(255,255,255,0.22), 22px 0 0 0 rgba(255,255,255,0.14)'}}>
