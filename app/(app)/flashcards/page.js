  ...
  return (
    <>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div style={{position:'absolute',top:8,left:8,right:-10,bottom:-8,borderRadius:16,border:'1px solid rgba(255,255,255,0.06)',background:'rgba(255,255,255,0.03)',pointerEvents:'none'}}/>
        <div style={{position:'absolute',top:4,left:4,right:-5,bottom:-4,borderRadius:16,border:'1px solid rgba(255,255,255,0.08)',background:'rgba(255,255,255,0.05)',pointerEvents:'none'}}/>
