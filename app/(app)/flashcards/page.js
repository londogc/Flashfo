...
function FlashcardsPageInner() {
  ...
  if (sessionComplete) return (
    <SessionComplete
      ...
      hardCards={sessionHardCards} againCards={sessionAgainCards}
  ...
  return (
    <>
      ...
      <div style={{display:'flex',gap:5,marginBottom:16,flexWrap:'wrap'}}>
        {cards.map((_,i)=>(
          <div key={i} style={{width:20,height:6,borderRadius:3,background:dots[i]||(i===currentIdx?'rgba(99,102,241,0.7)':'rgba(255,255,255,0.1)'),transform:i===currentIdx&&!dots[i]?'scaleX(1.2)':'none',transition:'background .35s,transform .2s'}}/>
        ))}
      </div>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div style={{position:'absolute',inset:0,borderRadius:16,border:'1px solid rgba(255,255,255,0.06)',background:'rgba(255,255,255,0.03)',transform:'rotate(3deg)',transformOrigin:'bottom center',pointerEvents:'none'}}/>
        <div style={{position:'absolute',inset:0,borderRadius:16,border:'1px solid rgba(255,255,255,0.08)',background:'rgba(255,255,255,0.05)',transform:'rotate(1.5deg)',transformOrigin:'bottom center',pointerEvents:'none'}}/>
