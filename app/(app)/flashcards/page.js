  ...
  return (
    <>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div style={{position:'absolute',top:4,left:22,right:-24,bottom:4,borderRadius:16,border:'1.5px solid rgba(255,255,255,0.22)',background:'rgba(255,255,255,0.07)',pointerEvents:'none'}}/>
        <div style={{position:'absolute',top:2,left:11,right:-12,bottom:2,borderRadius:16,border:'1.5px solid rgba(255,255,255,0.16)',background:'rgba(255,255,255,0.05)',pointerEvents:'none'}}/>
