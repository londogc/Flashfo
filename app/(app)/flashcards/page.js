  ...
  return (
    <>
      ...
      <div style={{position:'relative',width:'100%',maxWidth:560,margin:'0 auto',height:isMobile?220:250}}>
        <div style={{position:'absolute',top:0,left:10,right:-10,bottom:-8,borderRadius:16,border:'1px solid rgba(255,255,255,0.06)',background:'rgba(255,255,255,0.025)',pointerEvents:'none'}}/>
        <div style={{position:'absolute',top:0,left:5,right:-5,bottom:-4,borderRadius:16,border:'1px solid rgba(255,255,255,0.09)',background:'rgba(255,255,255,0.04)',pointerEvents:'none'}}/>
