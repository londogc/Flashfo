...
export default function HeroCard(){
  return(
    <div className="bg-surface border border-line rounded-2xl p-6 mb-3.5 grid gap-5 items-center" style={{gridTemplateColumns:'1fr 290px'}}>
      <div>
        ...
        <h1 className="text-[30px] font-extrabold text-t1 leading-[1.2] tracking-tight mb-3">
          Learn <span className="text-blue-600 dark:text-blue-400">faster</span> without<br/>juggling a dozen tools.
        </h1>
      ...
      <div className="bg-[#1e3a8a] rounded-2xl p-4 flex flex-col gap-2">
        ...
        <Opt icon={<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round"><path d="M8 1l1.8 5H15l-4.4 3.2 1.7 5.2L8 11.2 3.7 14.4l1.7-5.2L1 6h5.2z"/></svg>} label="Create learning material" sub="Summaries, cards, quizzes, lessons, worksheets"/>
        <Opt icon={<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round"><path d="M2 4h12M2 8h8M2 12h10"/></svg>} label="Continue learning" sub="Study mode, AI tutor, missed questions, guides"/>
        <Opt icon={<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round"><path d="M3 2h10a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V3a1 1 0 011-1z"/></svg>} label="Open saved work" sub="Folders, decks, quizzes, lessons, history"/>
      </div>
    </div>
  )
}