...
export default function Shell({ children }) {
  ...
  return (
    ...
    @keyframes ff-more-slide { from { opacity:0; transform:translateY(16px) } to { opacity:1; transform:translateY(0) } }
    @keyframes ff-pip-pop { from { transform:translateX(-50%) scale(0) } to { transform:translateX(-50%) scale(1) } }`}</style>
    ...
    : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
      ...
      <div className="ff-mobile-only">
        ...
        {moreOpen && (
          <div style={{
            position:'fixed', bottom:64, left:8, right:8, zIndex:99,
            background:'#161b22', border:'1px solid #21262d', borderRadius:16,
            padding:'12px 12px 8px', animation:'ff-more-slide .3s cubic-bezier(.22,.68,0,1.2) both'
          }}>
        ...
        <nav style={{
          ...
          {/* Home */}
          <Link href="/dashboard" style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, padding:'4px 6px', borderRadius:12, textDecoration:'none', minWidth:52, position:'relative' }}
            onClick={()=>setMoreOpen(false)}>
            <div style={{ width:44, height:36, display:'flex', alignItems:'center', justifyContent:'center', borderRadius:12,
              background: pathname==='/dashboard' ? 'rgba(59,130,246,.14)' : 'transparent', transition:'background .2s' }}>
            ...
            {pathname==='/dashboard' && <div style={{ position:'absolute', bottom:-1, left:'50%', transform:'translateX(-50%)', width:5, height:5, borderRadius:'50%', background:'#3b82f6' }}/>}
          </Link>

          {/* Create */}
          <Link href="/create" style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, padding:'4px 6px', borderRadius:12, textDecoration:'none', minWidth:52, position:'relative' }}
            onClick={()=>setMoreOpen(false)}>
            <div style={{ width:44, height:36, display:'flex', alignItems:'center', justifyContent:'center', borderRadius:12,
              background: pathname==='/create' ? 'rgba(167,139,250,.14)' : 'transparent', transition:'background .2s' }}>
            ...
            {pathname==='/create' && <div style={{ position:'absolute', bottom:-1, left:'50%', transform:'translateX(-50%)', width:5, height:5, borderRadius:'50%', background:'#a78bfa' }}/>}
          </Link>

          {/* Nova — floating centre button */}
          <Link href="/ai-tutor" style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, textDecoration:'none', minWidth:52, marginTop:-14, position:'relative' }}
            onClick={()=>setMoreOpen(false)}>
            <div style={{ position:'relative', width:52, height:52 }}>
              <div style={{ position:'absolute', inset:-3, borderRadius:21, background:'conic-gradient(#3b82f6,#8b5cf6,#a78bfa,#34d399,#3b82f6)', animation:'ff-nova-spin 3s linear infinite' }}/>
              <div style={{ position:'absolute', inset:2, background:'#0d1117', borderRadius:16, display:'flex', alignItems:'center', justifyContent:'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <circle cx="12" cy="12" r="10" stroke={pathname==='/ai-tutor'?'#a78bfa':'#a78bfa'} strokeWidth="1.4"/>
          ...
          {/* Study */}
          <Link href="/study" style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, padding:'4px 6px', borderRadius:12, textDecoration:'none', minWidth:52, position:'relative' }}
            onClick={()=>setMoreOpen(false)}>
            <div style={{ width:44, height:36, display:'flex', alignItems:'center', justifyContent:'center', borderRadius:12,
              background: pathname==='/study' ? 'rgba(52,211,153,.14)' : 'transparent', transition:'background .2s' }}>
            ...
            {pathname==='/study' && <div style={{ position:'absolute', bottom:-1, left:'50%', transform:'translateX(-50%)', width:5, height:5, borderRadius:'50%', background:'#34d399' }}/>}
          </Link>

          {/* More */}
          <button onClick={()=>setMoreOpen(o=>!o)}
            style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, padding:'4px 6px', borderRadius:12, background:'transparent', border:'none', cursor:'pointer', minWidth:52, position:'relative' }}>
            <div style={{ width:44, height:36, display:'flex', alignItems:'center', justifyContent:'center', borderRadius:12,
              background: moreOpen ? 'rgba(245,158,11,.14)' : 'transparent', transition:'background .2s' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            ...
            {moreOpen && <div style={{ position:'absolute', bottom:-1, left:'50%', transform:'translateX(-50%)', width:5, height:5, borderRadius:'50%', background:'#f59e0b' }}/>}
          </button>
