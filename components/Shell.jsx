  ...
  return (
    ...
    : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
      ...
      <div className="ff-mobile-only">
        ...
        {/* More drawer */}
        {moreOpen && (
          <div style={{position:'fixed',bottom:64,left:8,right:8,zIndex:99,
            background:'#161b22',border:'1px solid #21262d',borderRadius:16,
            padding:'12px 12px 8px',
            boxShadow:'0 -8px 32px rgba(0,0,0,0.5)',
            animation:'ff-more-in .25s ease both'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
              <Link href="/collab-decks" onClick={()=>setMoreOpen(false)}
                style={{display:'flex',alignItems:'center',gap:10,padding:'10px 12px',borderRadius:10,background:'#0d1117',border:'1px solid rgba(167,139,250,0.2)',textDecoration:'none'}}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" strokeWidth="1.5" strokeLinecap="round">
                  <rect x="2" y="5" width="9" height="8" rx="1"/><rect x="13" y="3" width="9" height="8" rx="1"/>
                </svg>
                <div>
              ...
              <Link href="/curriculum" onClick={()=>setMoreOpen(false)}
                style={{display:'flex',alignItems:'center',gap:10,padding:'10px 12px',borderRadius:10,background:'#0d1117',border:'1px solid rgba(52,211,153,0.2)',textDecoration:'none'}}>
              ...
              <Link href="/student-portal" onClick={()=>setMoreOpen(false)}
                style={{display:'flex',alignItems:'center',gap:10,padding:'10px 12px',borderRadius:10,background:'#0d1117',border:'1px solid rgba(245,158,11,0.2)',textDecoration:'none'}}>
              ...
              <Link href="/lesson-builder" onClick={()=>setMoreOpen(false)}
                style={{display:'flex',alignItems:'center',gap:10,padding:'10px 12px',borderRadius:10,background:'#0d1117',border:'1px solid rgba(37,99,235,0.2)',textDecoration:'none'}}>
        ...
        <nav style={{position:'fixed',bottom:0,left:0,right:0,zIndex:100,
          ...
          <Link href="/dashboard" onClick={()=>setMoreOpen(false)}
            style={{display:'flex',flexDirection:'column',alignItems:'center',gap:3,
              padding:'4px 6px',textDecoration:'none',minWidth:52}}>
            <div style={{width:44,height:36,display:'flex',alignItems:'center',justifyContent:'center',
              borderRadius:12,background:pathname==='/dashboard'?'rgba(59,130,246,.14)':'transparent',
              transition:'background .2s'}}>
              <div style={{color:pathname==='/dashboard'?'#3b82f6':'#6b7280'}}>
                <I d={ICONS.dashboard} s={22}/>
              </div>
            </div>
            <span style={{fontSize:9,fontWeight:600,color:pathname==='/dashboard'?'#e6edf3':'#484f58'}}>Home</span>
          </Link>

          <Link href="/create" onClick={()=>setMoreOpen(false)}
            style={{display:'flex',flexDirection:'column',alignItems:'center',gap:3,
              padding:'4px 6px',textDecoration:'none',minWidth:52}}>
            <div style={{width:44,height:36,display:'flex',alignItems:'center',justifyContent:'center',
              borderRadius:12,background:pathname==='/create'?'rgba(167,139,250,.14)':'transparent',
              transition:'background .2s'}}>
              <div style={{color:pathname==='/create'?'#a78bfa':'#6b7280'}}>
                <I d={ICONS.create} s={22}/>
              </div>
            </div>
            <span style={{fontSize:9,fontWeight:600,color:pathname==='/create'?'#e6edf3':'#484f58'}}>Create</span>
          </Link>

          <Link href="/ai-tutor" onClick={()=>setMoreOpen(false)}
            style={{display:'flex',flexDirection:'column',alignItems:'center',gap:3,
              textDecoration:'none',minWidth:52,marginTop:-14}}>
            <div style={{position:'relative',width:52,height:52}}>
              <div style={{position:'absolute',
                top:-3,left:-3,right:-3,bottom:-3,
                borderRadius:21,
                background:'conic-gradient(#3b82f6,#8b5cf6,#a78bfa,#34d399,#3b82f6)',
                animation:'sh-spin 3s linear infinite'}}/>
              <div style={{position:'absolute',
          ...
          <Link href="/study" onClick={()=>setMoreOpen(false)}
            style={{display:'flex',flexDirection:'column',alignItems:'center',gap:3,
              padding:'4px 6px',textDecoration:'none',minWidth:52}}>
            <div style={{width:44,height:36,display:'flex',alignItems:'center',justifyContent:'center',
              borderRadius:12,background:pathname==='/study'?'rgba(52,211,153,.14)':'transparent',
              transition:'background .2s'}}>
              <div style={{color:pathname==='/study'?'#34d399':'#6b7280'}}>
                <I d={ICONS.study} s={22}/>
              </div>
            </div>
          ...
          <button onClick={()=>setMoreOpen(o=>!o)}
            style={{display:'flex',flexDirection:'column',alignItems:'center',gap:3,
              padding:'4px 6px',background:'transparent',border:'none',cursor:'pointer',minWidth:52}}>
            <div style={{width:44,height:36,display:'flex',alignItems:'center',justifyContent:'center',
              borderRadius:12,background:moreOpen?'rgba(245,158,11,.14)':'transparent',
              transition:'background .2s'}}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
